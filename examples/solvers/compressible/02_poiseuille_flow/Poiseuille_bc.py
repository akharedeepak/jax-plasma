...
subkey, key = jax.random.split(key)
p_bc = col.boundaries.ConstantBoundaryConditions((('dirichlet', 'dirichlet'),('neumann','neumann')),((_p0,_p0-dpdx*Lx),(0,0)))
p0 = energy.initial_conditions.initial_T_field(subkey, grid, lambda x, y: _p0-dpdx*x, p_bc)
...
rho_bc = col.boundaries.ConstantBoundaryConditions((('dirichlet', 'dirichlet'),('neumann','neumann')),
                                                   ((_p0/(properties['R']*T0),(_p0-dpdx*Lx)/(properties['R']*T0)),(0,0)))
rho0 = energy.initial_conditions.initial_T_field(subkey, grid, lambda x, y: (_p0-dpdx*x)/(properties['R']*T0), rho_bc)
